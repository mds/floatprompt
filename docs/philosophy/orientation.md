...
1. **Upload `floatprompt/floatprompt-template.md`** to any AI system → activate floatprompt creation mode
...
**`floatprompt/floatprompt-template.md` (3KB)** - Universal template and system definition
...
**`floatprompt/floatprompt-os.md` (35KB)** - Full system with guided creation
...
**`floatprompt/floatprompt-doc.md`** - FloatDoc tool
- Generates YAML frontmatter for mutual understanding

**`floatprompt/floatprompt-update.md`** - Update planning tool
- Structured plans for significant changes
...
**Start Simple:** Upload `floatprompt/floatprompt-template.md` to your preferred AI system and say "float [anything]" to create custom collaboration tools. The system will guide you through enhanced AI partnership naturally.
