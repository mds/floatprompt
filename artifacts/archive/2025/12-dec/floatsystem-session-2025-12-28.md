...
FloatPrompt is "the invisible OS for AI." Feed a single `_system.md` to any AI, it boots up, penetrates folder structure, builds rich context, becomes aware of everything.
...
**Decision:** `_system.md`, `_float.md` — no underscores, no prefixes
...
| FloatSystem | `_system.md` | Boot loader |
...
1. Read _system.md → behavioral rules, structure map
...
The core (_system.md, _float.md, floatdoc frontmatter, sessions/) is solid and complete.
...
1. **Read _system.md first** (when it exists) — it's the boot loader
