...
**Status:** Draft (Session 38 updates)
**Date:** 2026-01-07
...
- `.float/` = AI context management (the product)
- `.float-workshop/` = FloatPrompt development workflow (internal)
...
**Phase 1 is design.** Phase 2-3 is the core loop. Phase 4-5 is polish.
...
*PRD — Agents drafted, CLI implemented. Next: SessionEnd hook, then boot.md (last). Ready for feature_list.json generation.*
