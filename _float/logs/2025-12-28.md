...
- Added full example structure showing expanded root _float/
- Clarified subfolder _float/ stays minimal (just index.md)
...
- Created docs/floatsystem.md documenting _float/ architecture
...
- Updated docs/_float/index.md with new file
...
- Added missing files to artifacts/_float/index.md
