...
format: "floatprompt"
type: "template"
system_version: "floatprompt v0.8.1-alpha"
...
behavioral_requirements:
  ...
  content_standards:
    ...
    - "ALL FloatPrompt outputs must be wrapped in fenced markdown code blocks: ```<floatprompt>...</floatprompt>``` for cross-platform portability"
...
certification:
  timestamp: "2025-06-17T16:11:59.436Z"
...
Comprehensive pre-deployment verification covering system authority compliance, goal hierarchy alignment, and archaeological preservation with complete checklist validation ensuring deployment readiness and human agency preservation.
