...
export const FolderSchema = z.object({
    ...
    context: z.string().nullable(), // Deeper understanding — "what it means"
    // === Scope (3) ===
...
export const LogEntrySchema = z.object({
    ...
    // Metadata
    files_read: z.array(z.string()).nullable(), // Stored as JSON — files AI read for understanding
    files_changed: z.array(z.string()).nullable(), // Stored as JSON — files AI modified
