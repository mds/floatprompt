...
1. Load type template from `.float/tools/types/[type].md`
...
- `.float/tools/manual.md` — Patterns and anti-patterns
- `.float/tools/types/[type].md` — Type-specific template
...
Generated: .float/tools/applicant-scorer.md
