...
├── dev/update-protocol.md          — How updates work
└── artifacts/                      — Historical archive (150+ files)
```
...
The `artifacts/2025/` folder contains 150+ files documenting the evolution of FloatPrompt. Current specifications live in `docs/`. Artifacts are archaeology — useful for understanding design decisions but may not reflect current state.
