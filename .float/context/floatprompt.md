...
3. `.float/nav/*.md` — All 10 navigation files for folder structure
...
├── .float/tools/float-context.md   — Tool for generating context
...
*Generated by Context Buoy using .float/tools/float-context.md*
