...
status: current
created: 2025-12-29
related: .float/system.md, docs/goals.md, docs/principles.md, floatprompt/core/template.md
...
| `floatprompt/core/os.md` | Full FloatPrompt OS (35KB) — the complete system with guided creation |
| `floatprompt/core/template.md` | Template for creating new FloatPrompt tools |
| `floatprompt/core/doc.md` | Tool for adding YAML frontmatter to documents |
...
6. `floatprompt/core/template.md` — The template (see how tools are built)
...
├── floatprompt/core/template.md     — Basic template
├── floatprompt/core/doc.md          — Document context tool
├── floatprompt/core/os.md           — Full OS with guided creation
└── floatprompt/tools/update.md      — Structured update planning
...
├── .float/floatprompt/                   — FloatPrompt internals
│   ├── core/                             — Templates (template, doc, os)
...
- **Structure**: `floatprompt/` for system internals, `project/` for your project
...
*Generated by Context Buoy using .float/floatprompt/tools/float-context.md*
