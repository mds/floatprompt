...
status: current
created: 2025-12-29
related: .float/system.md, docs/goals.md, docs/principles.md, format/core/template.md
...
├── format/core/template.md     — Basic template
├── format/core/doc.md          — Document context tool
├── format/core/os.md           — Full OS with guided creation
...
├── .float/core/                   — FloatPrompt internals
