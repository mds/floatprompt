...
const DEFAULT_OPTIONS: FloatButtonOptions = {
 ...
 */
function createIcon(type: 'copy' | 'check' | 'view'): SVGSVGElement {
 ...
 */
function createButtonContent(iconType: 'copy' | 'check' | 'view', label: string): DocumentFragment {
 ...
 */
export function mount(options: FloatButtonOptions = {}): void {
  // Don't mount twice
  if (buttonElement) {
 ...
 */
function showFeedback(trigger: HTMLElement, success: boolean, originalLabel: string): void {
