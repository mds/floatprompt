 ...
 */
function isOwnPackage(pkg: PackageJson): boolean {
 ...
 */
function hasBuildScript(pkg: PackageJson): boolean {
 ...
 */
function hasFloatPromptInPostbuild(pkg: PackageJson): boolean {
