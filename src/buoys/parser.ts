import { BuoyJsonSchema, BuoyTemplate, ParseResult } from "./schema.js";
 ...
 */
export function parseBuoyTemplate(
  content: string,
  sourcePath: string
): ParseResult {
 ...
 */
export function isValidFloatPromptFormat(content: string): boolean {
  return (
    content.includes("<fp>") &&
    content.includes("</fp>") &&
